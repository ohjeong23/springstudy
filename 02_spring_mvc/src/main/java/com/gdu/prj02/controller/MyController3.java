...
public class MyController3 {
  ...
  public String detail(HttpServletRequest request) {
    ...
    return "index";
    //한번 클릭하고 다시 인덱스로 돌아가게 리퀘스트로 꺼내고 돌려보냄
  ...
  public String detail2(@RequestParam (value="article_no"
                                       , required=false  //꼭안와도 되는데 안오면 아티클 넘버 1이다.
                                       , defaultValue="1") int article_no) {
    //   <a href="${contextPath}/article/detial2.do?article_no=10">article 상세2</a> 파라미터 아티클 넘버를 받아야함
   ...
   *   3) 자동으로 Model 에 저장된다. 
   *   커맨드 객체를 이용하면 자동으로 모델에 저장되는지 확인
   */
